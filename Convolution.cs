...
namespace ImageProcessing
{
    static class Convolution
    {
        ...
        {
            double[,] MatrixHorizontal = Sobel3x3Horizontal;
            double[,] MatrixVertical = Sobel3x3Vertical;
            Bitmap resultBitmap =
                   ConvolutionFilter(sourceBitmap,
                                  MatrixHorizontal,
                                    MatrixVertical,
        ...
        {
            double[,] MatrixHorizontal = Kirsch3x3Horizontal;
            double[,] MatrixVertical = Kirsch3x3Vertical;
            Bitmap resultBitmap =
                   ConvolutionFilter(sourceBitmap,
                                 MatrixHorizontal,
                                   MatrixVertical,
        ...
        public static Bitmap RobertsFilter(this Bitmap sourceBitmap, bool grayscale = true)
        {
            double[,] MatrixHorizontal = RobertsHorizontal;
            double[,] MatrixVertical = RobertsVertical;
            Bitmap resultBitmap =
                   ConvolutionFilter(sourceBitmap,
                                 MatrixHorizontal,
                                   MatrixVertical,
        ...
        public static double[,] RobertsHorizontal
        {
            get
            {
                return new double[,]
        ...
        public static double[,] RobertsVertical
        {
            get
            {
                return new double[,]
